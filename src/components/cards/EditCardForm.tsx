...
export default function EditCardForm({ card, onCardUpdated, onCancel }: EditCardFormProps) {
	...
	return (
		<form
			...
			className="bg-light dark:bg-dark rounded-xl shadow-lg p-4 sm:p-6 md:p-8 space-y-4 border-2 border-primary border-opacity-30"
		>
			<div className="flex justify-between items-center">
				<h3 className="text-2xl font-semibold text-primary dark:text-primary font-serif">Edit Card</h3>
